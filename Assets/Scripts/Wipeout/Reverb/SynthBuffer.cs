namespace Wipeout.Reverb
{
    public struct SynthBuffer : INativeObject
    {
        ...
        public void CopyTo(float[] managedArray)
        {
            _buffer.CopyTo(managedArray);
        }

        public void CopyTo(ref SynthBuffer buffer)
        {
            _buffer.CopyTo(buffer._buffer);
        }
